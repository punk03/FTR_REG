...
Для удобного управления Docker-окружением используйте скрипт `docker-manage.sh`:
...
Скрипт предоставляет интерактивное меню с функциями:
- **Мониторинг Docker** — отслеживание статуса контейнеров и использования ресурсов в реальном времени
- **Обновление из репозитория** — автоматическое обновление кода из GitHub
- **Установка обновлений** — пересборка и запуск контейнеров
- **Быстрое обновление** — комбинация обновления репозитория и установки обновлений
- **Просмотр логов** — просмотр логов всех сервисов или конкретного сервиса
- **Управление контейнерами** — остановка, запуск, перезапуск
